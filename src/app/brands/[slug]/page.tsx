...
export default function SingleBrandPage() {
  ...
  // Safe Context Bridge to prevent TypeScript errors across different Cart/Wishlist context schemas
  ...
  // Add to Cart Action (Supports addItem, addToCart, or addItemToCart dynamically)
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-20 bg-white rounded-3xl border border-gray-100 shadow-sm max-w-md mx-auto">
            ...
            <p className="text-xs text-gray-400 mb-4">Try clearing filters or search term.</p>
            <button
