...
// NOTE: Hardcoded HERO_SLIDES has been removed!
...
// 1. Props mein initialHeroSlides add kiya
...
// 2. Destructure karte time initialHeroSlides liya
export default function HomePageClient({ initialProducts, initialCategories, initialHeroSlides }: HomePageClientProps) {
  
  const products = initialProducts;
  const categories = initialCategories;
  
  // 3. Agar WordPress se data nahi mila, toh fallback data dikhega jisse error na aaye
  ...
  // 4. Timer ko heroSlidesData.length ke hisaab se set kiya
  useEffect(() => {
  ...
  return (
    <div className="w-full overflow-hidden bg-white">
      ...
      <section className="relative w-full h-[60vh] md:h-[80vh] bg-gray-900 group overflow-hidden">
        {/* 5. HERO_SLIDES ki jagah heroSlidesData use kiya gaya hai */}
